...
<main class="row container-fluid col-12">
  <article class="container-fluid user-profile-page col-12 d-flex justify-content-center text-center">
    <section class="personal-info-container d-flex flex-row">
      ...
      <div class="d-flex flex-column personal-information">
        <form action="actions/personal-info-change-action.php?id=<?php echo $userId?>" method="post"
          enctype="multipart/form-data">
        ...
        <form action="actions/password-change-action.php?id=<?php echo $userId?>" method="post"
          enctype="multipart/form-data">
