                            ...
                            ?>
                              <div class="job-box d-md-flex align-items-center justify-content-between mb-30">
                                <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                                    ...
                                    <a href="job-details.php?id=<?php echo $project["id"] ?>"><img src="assets/images/projects/<?php echo $project["mainImg"] ?>" alt="Project Image" style="width:80px;height:80px;border-radius:100%;"></a>
                                    </div>
                                    <div class="job-content">
                                        <h5 class="text-center text-md-left"><a href="job-details.php?id=<?php echo $project["id"] ?>"><?php echo $project["title"] ?></a></h5>
